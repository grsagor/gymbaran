...
const FourthSection = () => {
    return (
        <div className="w-10/12 mx-auto grid grid-cols-1 lg:grid-cols-3 my-6 bg-gradient-to-r from-indigo-600 to-indigo-400 p-12 rounded-2xl text-white">
            <div className="flex gap-5 w-3/4">
                <div className="bg-indigo-500 p-4 h-24 w-24 rounded-lg">
                    <Image
                        src={first}
                    />
                </div>
            ...
            <div className="flex gap-5 w-3/4">
                <div className="bg-indigo-400 p-4 h-24 w-24 rounded-lg">
                    <Image
                    src={second}
                />
                </div>
            ...
            <div className="flex gap-5 w-3/4">
                <div className="bg-indigo-300 p-4 h-24 w-24 rounded-lg">
                    <Image
                    src={third}
                />
                </div>
